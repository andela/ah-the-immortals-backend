...
class TestUserSignup(BaseTest):
    ...
    def test_successful_signup(self):
        ...
        """
        response = self.signup_user("eve", "eve@gmail.com", "@UUss35r.com")
    ...
    def test_signup_without_value(self):
        ...
        """
        response = self.signup_user("", "eve@gmail.com", "@UUss3r.com")
    ...
    def test_signup_with_invalid_value(self):
        ...
        """
        response = self.signup_user("evegirl", "evegmail.com", "@UUss3r.com")
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_signup_with_existing_user(self):
        ...
        """
        response = self.signup_user("adam", "adam@gmail.com", "@UUss3r.com")
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
...
class TestUserLogin(BaseTest):
    ...
    def test_login_with_correct_credentials(self):
        ...
        """
        response = self.login_user("adam@gmail.com", "@UUss35r.com")
    ...
    def test_login_with_incorrect_credentials(self):
        ...
        """
        response = self.login_user("dam@gmail.com", "@UUss35r.com")
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
...
class TestUserUpdate(BaseTest):
    ...
    def test_update_with_user_login(self):
        ...
        """
        self.authenticate_user("adam@gmail.com", "@UUss35r.com")
        response = self.update_user("admin1", "adam@gmail.com", "@UUss35r.com")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_update_with_invalid_value(self):
        ...
        """
        self.authenticate_user("admin@authors.com", "adm123Pass!!")
        response = self.update_user("admin1", "adamgmail.com", "@UUss35r.com")
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
